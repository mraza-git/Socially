import stepperhorizontalTemplate from './templates/horizontal/horizontal.html';
import stepperverticalTemplate from './templates/vertical/vertical.html';
import stepperverticalstepTemplate from './templates/vertical/step/vertical-step.html';
...
(function ()
{
    ...
    function msHorizontalStepperDirective()
    {
        return {
            ...
            transclude      : true,
            template     : stepperhorizontalTemplate,
    ...
    function msVerticalStepperDirective($timeout)
    {
        return {
            ...
            transclude      : true,
            template     : stepperverticalTemplate,
            compile         : function (tElement)
            {
                tElement.addClass('ms-stepper');
    ...
    function msVerticalStepperStepDirective()
    {
        return {
            ...
            transclude : true,
            template: stepperverticalstepTemplate,
            compile    : function (tElement)
            {
                tElement.addClass('ms-stepper-step');
