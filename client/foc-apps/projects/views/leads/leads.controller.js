...
(function ()
{
    ...
    /** @ngInject */
    function ProductsController($state, Products,$mdDialog)
    {
        var vm = this;
        ...
        // {
        //     $state.go('app.projects.leads.detail', {id: id});
        // }

        function gotoProductDetail(product,ev)
        {
          console.log("Function Called");
          var confirm = $mdDialog.confirm()
                .title('Are you sure you want to buy this Lead?')
                .htmlContent('<br>'+ "This lead of  <b> "+ product.category + "</b> will cost you:<b> " + product.price + '</b>' + '<br> Press confirm to proceed.')
            ...
            {
              $state.go('app.projects.myleads.detail',{id: product.id});
            }, function ()
            {
